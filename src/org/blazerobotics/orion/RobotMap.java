...
public class RobotMap {
    ...
    public static void init() {
        ...
        intakeBarMotor = new Talon(5);
        LiveWindow.addActuator("Intake Bar Subsystem", "Motor", (Talon) intakeBarMotor);
        ...
        genericSensorSubsystemGyro = new Gyro(1);
